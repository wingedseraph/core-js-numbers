...
/**
 * Returns a string representation of a number in a specified base (d).
 *
 * @param {number} number
 * @param {number} base
 * @return {string}
...
/**
 * Returns a string representation of a number in normal (xed-point or exponenti)
 ...
 * 0, 5   => 5
 */
function getMaxNumber(rstNumber, secondNumb) {
  return Math.max(rstNumber, secondNumb);
}
